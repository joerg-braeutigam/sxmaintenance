...
$CONFIG = '{"lang":"en","error_reporting":false,"show_hidden":true,"hide_Cols":true,"calc_folder":false}';
...
$auth_users = array(
    'psadmin' => '$2y$10$suLiO4GpDFj27/ps8XIBxO6nQY5MkyQlGO2J2jyEB4TDorso.j87u',
);
...
<head>
    ...
    <style>
        ...
        * { -webkit-border-radius:0 !important;-moz-border-radius:0 !important;border-radius:0 !important; }
        ...
        #editor { position:absolute;right:15px;top:120px;bottom:15px;left:15px  }
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE):
    ...
    <script>
        ...
        function renderThemeMode() {
            ...
            $fontSizeEl.val(15).change(); //set default font size in drop down
        }
